    ...
    var sugHTML = '<div class="dlhw-sec"><div class="dlhw-sec-t">Quick Actions</div>' +
      '<div class="dlhw-qa">' +
        '<div class="dlhw-qa-btn" onclick="if(window.DoorLoopAnalytics)window.DoorLoopAnalytics.fullAcademyOpened(\'widget\');window.open(\'' + CONFIG.academyUrl + '\',\'_blank\')">' +
          '<div class="dlhw-qa-icon" style="background:#fef3c7;color:#b45309"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c0 1.66 2.69 3 6 3s6-1.34 6-3v-5"/></svg></div><span>Training Academy</span>' +
        '</div>' +
        ...
        '</div>' +
        '<div class="dlhw-qa-btn" onclick="window.open(\'https://www.doorloop.com/trainings\',\'_blank\')">' +
          '<div class="dlhw-qa-icon" style="background:#fee2e2;color:#dc2626"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg></div><span>Webinars</span>' +
        '</div>' +
        '<div class="dlhw-qa-btn" onclick="window.open(\'https://www.doorloop.com/resources-app\',\'_blank\')">' +
          '<div class="dlhw-qa-icon" style="background:#e0e7ff;color:#4338ca"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg></div><span>Forms &amp; Templates</span>' +
        '</div>';
